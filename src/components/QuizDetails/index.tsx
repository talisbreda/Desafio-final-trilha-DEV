    ...
    <div className='wrapper details-wrapper'>
      ...
      <div className='quiz-details about-quiz'>
        ...
        <p className='p-medium'>
          ...
          dignissimos officia mollitia quibusdam atque id magni qui at similique
          obcaecati, velit voluptas unde temporibus nam voluptatum eligendi
          sequi doloremque tempora.
        </p>
      </div>
